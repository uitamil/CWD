(function ($) {
  ...
  let thmOwlCarousels = $(".CWD-owl__carousel");
  ...
  function thmTinyInit() {
    // tiny slider
    const tinyElm = document.querySelectorAll(".CWD-tiny__slider");
  ...
  function CWD_stretch() {
    var i = $(window).width();
    $(".row .CWD-stretch-element-inside-column").each(function () {
      var $this = $(this),
